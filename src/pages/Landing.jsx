            ...
            <div className="grid grid-cols-1 gap-3 sm:gap-4 mb-8">
              <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-xl border border-gray-100 group hover:border-red-200 transition-colors">
                <div className="flex items-center min-w-0">
                  ...
                  <span className="font-bold text-gray-800 text-sm sm:text-base truncate">{t.ambulance}</span>
                </div>
                <a href="tel:108" className="text-blue-600 font-bold hover:underline text-sm sm:text-base flex-shrink-0">108</a>
              </div>
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-xl border border-gray-100 group hover:border-red-200 transition-colors">
                <div className="flex items-center min-w-0">
                  ...
                  <span className="font-bold text-gray-800 text-sm sm:text-base truncate">{t.healthHelpline}</span>
                </div>
                <a href="tel:104" className="text-blue-600 font-bold hover:underline text-sm sm:text-base flex-shrink-0">104</a>
              </div>
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-xl border border-gray-100 group hover:border-red-200 transition-colors">
                <div className="flex items-center min-w-0">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 bg-white rounded-lg shadow-sm flex items-center justify-center mr-3 sm:mr-4 text-pink-600 flex-shrink-0">
                    <span className="font-bold text-sm sm:text-base">181</span>
                  </div>
                  <span className="font-bold text-gray-800 text-sm sm:text-base truncate">{t.womenHelpline}</span>
                </div>
                <a href="tel:181" className="text-blue-600 font-bold hover:underline text-sm sm:text-base flex-shrink-0">181</a>
              </div>
            </div>

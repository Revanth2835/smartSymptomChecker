                    ...
                    {category.symptoms.map((symptom) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {isSelected && (
                              <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 h-4 text-white" />
                            )}
                          </div>
                          <span
                            className={`text-sm sm:text-base font-medium leading-tight ${isSelected ? "text-blue-900" : "text-gray-700"}`}
                          >
                            {t[symptom.id]}
                          </span>
                        </label>
            ...
            <div className="mt-6 text-xs sm:text-sm text-gray-400 text-center max-w-xs sm:max-w-md px-4">
              <p className="leading-relaxed">
                ...
                {language === "en"
                  ...
                  : `${selectedSymptoms.length} లక్షణాలు ఎంచుకోబడ్డాయి`}
              </p>
            </div>
          </div>
        </div>
